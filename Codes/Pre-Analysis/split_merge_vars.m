...
% merge them into vars. Since it uses cut-off dates, it only applies to G10 currencies.
% 
%     INPUTS
...
% Split the variables using the cut-off date and then merge them
...
% https://www.mathworks.com/matlabcentral/answers/252303-script-vs-function-with-no-input-output