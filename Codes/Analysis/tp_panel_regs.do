...
* Define variables
global y1 TP
global y2 log_VIX FFR USTP10 SPX INF UNE IP zCCY STX OIL
global x1 log_VIX FFR SPX OIL
global x2 log_VIX FFR USTP10 SPX OIL
global x3 INF UNE IP zCCY STX
global x4 log_VIX FFR SPX OIL INF UNE IP zCCY STX
global x5 log_VIX FFR USTP10 SPX INF UNE IP zCCY STX
global x6 log_VIX FFR USTP10 INF UNE IP RFX STX
...
xtreg $y1 $x2, fe vce(robust)
outreg2 using tp_regs.xls, replace label dec(2) addtext(Country FE, YES)
xtreg $y1 $x3, fe vce(robust)
...
xtreg $y1 $x8, fe vce(robust)
outreg2 using tp_regs.xls, append label dec(2) addtext(Country FE, YES)
*xtreg $y1 $x8 i.DATE, fe vce(robust)
*outreg2 using tp_regs.xls, append label keep($x8) addtext(Country FE, YES, Year FE, YES)
