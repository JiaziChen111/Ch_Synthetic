...
% m-files called: vars2parest, parest2vars, loadings
...
%     fltrnm = ismember(S(k0).(fnameb)(1,:),matsout);
...
%     datesn = S(k0).(fnameb)(2:end,1);                                       % dates
    ...
    fltrsn = ismember(S(k0).(fnameb)(1,:),matsout);
...
%     Jphi    = nan(nmats,ntheta,nobssn);                                      % check: nobsnm or nobssn
    for k1 = 1:ntheta
