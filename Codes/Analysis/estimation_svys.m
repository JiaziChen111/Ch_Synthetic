function [ylds_Q,ylds_P,termprm,params] = estimation_svys(yldsvy,matsY,matsS,matsout,dt,params0)
...
params.rho0  = rho0;    params.lmbd0 = lmbd0;
params.rho1  = rho1;    params.lmbd1 = lmbd1;
params.cSgm  = cSgm;    params.sgmY  = sgmY;    params.sgmS  = sgmS;        % sgmS reported for completeness