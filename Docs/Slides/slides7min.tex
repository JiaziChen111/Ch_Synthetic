...
\note{Hi, my name is Pavel Solís. My JMP addresses the question: How does US MP transmit to the sovereign bond yields of EM?
	To answer the question, I first propose a decomposition of the yields that explicitly takes into account the risk that EM may default. I then use the decomposition to understand the effects of US MP surprises on each component.}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \alert{Local} currency: \alert{90\%} of EM sovereign debt in 2018 %%\note{Table 1 IMF-WB staff note to G20 11/12.2 = 90\%.}
			\newline
		\end{itemize}
	\end{itemize}
...
\begin{frame}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\item Response of EM term premia similar to AE term premia
