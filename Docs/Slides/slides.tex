...
%	\iftoggle{struct}{\item<2->}{\item} 
	...
	\alert{Daily} data: January 2000 to August 2021
...
%		\iftoggle{struct}{\item<5->}{\item}
		\item $\yUS$: \(<\) 1Y from H.15; \(\geq\) 1Y from \citet*{GSW:2007} 
%		\vspace{-0.1cm}
...
\begin{itemize}
	\item Bond yields persistent and term premium unobserved
...
\begin{itemize}
	\item Anchor long run mean of interest rates
