...
\note{In 2000, a little more than 40\% of world GDP was produced by EMs. By 2019, the situation flipped, now 60\% of world GDP is produced by EMs. They overtook AEs in 2007.}
 ...
 \begin{frame}
	...
	\end{textblock*}
\end{frame}
\note{Bonds denominated in LC have become an important source of funds for EMs.}
\note{G20 supports local currency bond markets in emerging economies since 2011.}
\note{Both sovereign and corporate bond markets, as well as the role of foreign investor participation.}
...
\note{EMs: Argentina, Brazil, China, Colombia, Egypt, Hungary, India, Indonesia, Lebanon, Malaysia, Mexico, Pakistan, Philippines, Poland, Qatar, Russia, Saudi Arabia, South Africa, Thailand, Turkey.}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\end{itemize}
		\item International spillovers from advanced economies (AEs)
	\end{itemize}
\end{frame}
\note{These questions have barely received attention in the literature.}
\note{Importance: Better understanding of vulnerabilities in global financial system.}
\note{New perspective on the role of the global financial cycle.}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Results: Comovement, determinants %, spillovers
	\end{itemize}
\end{frame}
...
\end{frame}
\note{Today I can lock in a risk-free investment in LC by exchanging LC for USD, investing those USD in Tresuaries and enter into a forward agreeing to sell USD for LC in the future. Once I receive the payment from Treasuries, I exchange them into LC.}
\note{Nevertheless, correlation b/w XCS and CDS is high.}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\end{itemize}
%		\item Estimating an ATSM for the dynamics of $\yLCsynt$ allows to decompose $\yLCnom$ into 3 parts:
	\end{itemize}
\end{frame}
...
\note{Two ways in which the information from surveys is used. (1) to obtain a model-free estimate of the term premium. (2) to supplement the information from bond yields in the estimation of affine term structure models.}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\end{itemize}
		\iftoggle{struct}{\item<2->}{\item} Sample: End-of-month data from Jan-2000/Dec-2006 to Jan-2019
%		\iftoggle{struct}{\item<2->}{\item} End-of-month data until Jan-2019, starting dates vary (Jan-2000, Dec-2006)
		...
		\begin{itemize}
			...
			\vspace{-0.1cm}
			\iftoggle{struct}{\item<6->}{\item} $\fwdprm$: Bloomberg and Datastream
			\vspace{-0.1cm}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Comparison against U.S. term premium and uncertainty measures
		\end{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		\item Estimated TP is on average larger than CIP deviations
		\item Main component of the nominal yield curve:
		\begin{itemize}
			\item EMs: expectation of the future short-term interest rate
...
\note{The numbers in the table do not add up exactly for two reasons: (1) the term premium is obtained using equation yQ-yP, that is it uses the fitted synthetic yield curve, while the table reports the observed synthetic yield curve for the column `Synthetic', and (2) the sample period for the yield curves might differ slightly to that of the CIP deviations.}

\begin{frame}
	\frametitle{Benchmark: U.S. Term Premium}
	\begin{itemize}
		\item Stylized facts for U.S. term premium:
		\begin{enumerate}
...
\note{Uncertainty indexes \citep{BakerBloomDavis:2016}.}
