\begin{abstract}
	This paper documents the channels through which U.S. monetary policy influences the bond yields of emerging markets.
	I show that traditional decompositions of sovereign yields are not suitable in this case because they rely on a default-free assumption. 
	...
	The responses of yields are strong, yet delayed, and depend on the type of news. 
	Surprise changes in the policy rate are primarily transmitted through the expected short rate, whereas the responses to news on forward guidance and asset purchases are mainly driven by the term premium. 
	The reaction of the credit risk compensation is temporary, except for news on asset purchases.
