\begin{abstract}
	...
	Credit risk in emerging market yields is not zero, so traditional yield decompositions are biased.
	...
	\vspace{0.5cm}
	\noindent \textit{Keywords}: Emerging markets, synthetic yields, term premium, credit risk, monetary policy spillovers, affine term structure models.
