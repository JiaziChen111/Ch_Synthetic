...
As mentioned before, the relevant yield curve for advanced countries is the nominal one\(\yLCnom\), whereas for emerging markets it is the synthetic one \(\yLCsynt\).\footnote{ When there is missing data on yields, the principal components are obtained by .}
