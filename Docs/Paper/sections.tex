...
Since sovereign yields compensate investors for different motives, decomposing them would provide further insights about the extent to which they are interconnected.
...
\iftoggle{cboxes}{	   				  % Turn it on/off in packages.tex
	\begin{boxeditems}
		...
		\item BFV (CE par yield) and IYC (CE zero yield) curves in BLP so conversion to CC zero yields to which NS is fitted.
	\end{boxeditems}}{}
