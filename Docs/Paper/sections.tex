...
Therefore, what matters for emerging market yields are generally not spillovers originating in other emerging markets but in advanced countries, which makes the argument of a global financial cycle stronger, not weaker.
...
\subsection{Response of Yields to U.S. Monetary Policy} \label{sec:LPs}
\iftoggle{toclinks}{\gototoc}{} % Turn it on/off in packages.tex, command in macros.tex
...
on-impact response: direction, magnitude, plausibility
regional effects, relation to AEs and US
explanation
