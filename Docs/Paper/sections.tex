...
For all countries, the pricing factors are the first three principal components (PCs) of the respective yield curves, they are commonly known as level, slope and curvature \citep{LittermanScheinkman:1991}.
...
Figure \ref{fig:s_ylds_ssb_yQ} illustrates the fit of the model for the 10-year synthetic yields of emerging markets. 
The squared root of the average (across months and maturities) squared difference between the actual and the fitted yields is commonly used to summarize the fitting errors. % how well the model fits the data.
...
The dynamics of emerging market yields, however, are relatively harder to capture, fitting errors average 16 basis points.\footnote{ The short end of the yield curves of Indonesia and Philippines are particularly difficult to model; at some months, the short-term yields (3 and 6 months) fluctuate comparatively more than the rest of the curve.}
...
Figure \ref{fig:realrt_LT} verifies that this is the case.
