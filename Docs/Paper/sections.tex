...
In either case, the price of default risk (not necessarily the risk itself) increases. 
This effect can be seen as a fiscal implication in emerging markets of Fed's monetary policies. %, something that has not been discussed so far in the literature.
