...
Getting the timing right is key to adequately measure the responses of the emerging market yields to the U.S. monetary policy shocks.
...
Due to differences in time zones across countries and in the timing of the Fed announcements (14 hours New York time) and the publication of the Libor (11:55 hours London time), the forward premium for maturities equal or larger than one year (which are based on the Libor) is shifted one day forward for all countries. 
...
Similarly, since the nominal yields reported by Bloomberg are pulled at around 16 hours New York time, the nominal yields of countries not in the Western Hemisphere are shifted one day forward so that their daily changes adequately capture surprises in Fed announcements.
