...
Moreover, the measures of comovement are are unconditional, and so not specifically driven by monetary policy surprises. % but are rather calculated for all yield curve movements.
