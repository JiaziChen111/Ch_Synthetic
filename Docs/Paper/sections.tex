...
%figures \ref{subfig:dyindex10yEM} and \ref{subfig:dyindex10yAE} are measuring the connectedness of the periphery and the core, respectively.
%Therefore, 
...
% (see figure \ref{subfig:dyindex10yEM}).
...
The global and U.S. versions of the EPU index are used as alternative measures of global uncertainty.
