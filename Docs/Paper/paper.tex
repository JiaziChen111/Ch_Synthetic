...
\title{\input{../Settings/title}
	\iftoggle{fulldraft}{
		\thanks{I am particularly grateful to Jonathan Wright for insightful discussions and feedback. I also thank Derin Aksit, Laurence Ball and Olivier Jeanne for their helpful comments, and Jeongwon Son for discussions about the data. All remaining errors are mine. The codes used to generate the results in this paper can be found in the author's website \url{https://pavelsolis.github.io/research}.}
	}
	{\\ \large Outline}
	}
