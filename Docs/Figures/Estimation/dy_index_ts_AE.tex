...
\begin{document}
	\begin{figure}[tbph]
		\caption{Comovement of the Term Structures of Advanced Countries} \label{fig:dy_index_ts_AE}
		\begin{center}
			\begin{minipage}{0.9\linewidth}
				\begin{center}
					\begin{subfigure}[t]{\linewidth}
						...
						\vspace{-0.37cm}
						\caption{Rolling Correlations} \label{subfig:rollingTSAE}
%						\vspace{0.4cm}
					\end{subfigure}
					...
					\begin{subfigure}[t]{\linewidth}
						...
						\vspace{-0.37cm}
						\caption{Connectedness Index: 10-Year Yields} \label{subfig:dyindexTSAE}
						\vspace{0.2cm}
					\end{subfigure}
