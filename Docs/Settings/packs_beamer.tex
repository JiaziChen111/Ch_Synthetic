%% Packages for Beamer
% Conditionals, Fromatting, Figures, Tables, Math, Hyperlinks
% and References, Special Characters, Colors, Theme, Lists
...
% Fromatting
%---------------------------------------------------------------
\usepackage{FiraSans}							% font for metropolis theme
\usepackage{appendixnumberbeamer}	% add appendix, omit it from counter
...
% Figures
%---------------------------------------------------------------
%\usepackage{standalone}			  		   % To compile sub-files as part of main
...
%\usepackage{pgfplots}						% simplifies inclusion of scientific graphs
...
% Theme
%---------------------------------------------------------------
\usetheme{metropolis}		% Good: Madrid, Copenhagen, CambridgeUS, Boadilla
...
%\setbeamercolor{alerted text}{fg=blue} % midnightblue
...
%\setbeamertemplate{itemize items}{\(\bullet\)}		 % Or {$\vdash$}, {$\bullet$}, {$\rightharpoonup$}, {---}
\setbeamertemplate{itemize subitem}{\(\textendash\)} %[square]
%\setbeamertemplate{itemize subsubitem}{\(\textendash\)} %\textbullet
