...
% Theme
%---------------------------------------------------------------
 \usetheme{Madrid}		% Like: Madrid, Copenhagen, CambridgeUS, Boadilla
\useoutertheme{noslidenum}
\usecolortheme{lily} 	% Like: lily, dolphin
\usefonttheme{serif}
...
% Fromatting
%---------------------------------------------------------------
\usepackage{setspace} 	% For defining line spacing and setting spaces above/below an equation
\setstretch{1.7}
...
%\setbeamertemplate{itemize items}{$\vdash$}
...
\usepackage{textpos}			% For position text in slide (e.g. links to slides)
