%% Packages
% Title Page, Conditionals, Contents, Layout, Formatting, Math, Figures and Tables,
...
%\usepackage[colorlinks=true]{hyperref} 	% Creates hyperlinks, 'true' gets rid of boxes
...
%\usepackage[options]{nohyperref}		  % Removes links
%\usepackage{url}									 % To make \url work
