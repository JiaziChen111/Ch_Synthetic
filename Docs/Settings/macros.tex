...
%-------------------------------------------------------------------
\providecommand{\tnr}{n}
\providecommand{\fInst}{f_{\tnr,t}}
\providecommand{\yZero}{y_{\tnr,t}}
\providecommand{\Pzero}{P_{\tnr,t}}
\providecommand{\Pzerolag}{P_{\tnr-1,t+1}}
\providecommand{\rShort}{r_{t}}
...
\providecommand{\yLCnom}{y_{\tnr,t} ^{LC}}
\providecommand{\yLCsynt}{\widetilde{y}_{\tnr,t} ^{LC}}
\providecommand{\yUS}{y_{\tnr,t} ^{US}}
\providecommand{\yUSsynt}{\widetilde{y}_{\tnr,t} ^{US}}
...
\providecommand{\fwdprm}{\rho_{\tnr,t}}
