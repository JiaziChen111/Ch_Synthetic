...
\providecommand{\yZeroFwd}{\yld_{\idxsfwd}}
...
\newcommand{\eqpanelLP}{\yld_{\idxspnlfwd} - \yld_{\idxspnllag} = \alpha_{\idxi} + \beta_{\idxh} \epsilon_{\idxt} + \gamma_{\idxh} \yld_{\idxi,{\idxt-2}} + \phi_{\idxh} \fx_{\idxspnllag}  + u_{\idxspnlfwd}}
...
% Subcaptions
%---------------------------------------------------------------
% Notes after figures by Jörg Weber
\newcommand{\figtext}[1]{
	\vspace{-1.9ex}
...
\newcommand{\fignote}[1]{\figtext{\emph{Notes:~}~#1}}
