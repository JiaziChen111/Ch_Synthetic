...
\begin{todolist}
	...
	\begin{todolist}
		...
		\item Check which parameters seem to be precisely estimated.
		\item Use linewidth to make lines in Matlab bigger.
		\item LPs. Update equation and figures (including path pre/post).
		\item Fisher equation rather than approximation.
	\end{todolist}
	\item Wording.
	\begin{todolist}
