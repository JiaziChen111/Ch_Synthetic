...
\gototoc
\begin{todolist}
	\item Make sure all monthly data (yields, surveys, macro) has SAME end-of-month dates.
	\item Add als in pca to be able to estimate JSZ for initial values. No need to construct balanced panels to estimate ATSM but leave them b/c already coded and might have some use in the future.
	\item Estimate ATSM for AEs and EMs. Save TP w/ JSZ and w/ surveys for LCNOM and LCSYNT.
