...
\begin{todolist}
	\item Figures.
	\begin{todolist}
		\item Adjust target and LSAP shocks in spov_vars.
		\item Let y label on the left most LP panel.
		\item Mark on impact effect w/ red.
		\item Reduce horizon to 30 and 60 days.
