...
\begin{todolist}
	...
	\begin{todolist}
		...
		\item Make references in the main text to all things in appendices.
...
\begin{todolist}
	\item Slides.
	\begin{todolist}
		\item Include figure for yield decomposition, reflecting (in terms of sizes per maturity) averages of components.
		\item Include cashflow diagram to construct synthetic yields.
