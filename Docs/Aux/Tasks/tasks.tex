...
\begin{todolist}
	...
	\begin{todolist}
		...
		\item Re-estimate baseline models (mnsb, mssb) for HUF (0.16), IDR (0.39), ILS (0.10), MYR (0.17), THB (0.135), TRY (0.12), ZAR (0.07). 
		\item Re-estimate baseline models (mnsb, mssb) for PHP (0.37).
		\item Redefine baseline estimations (for ILS and ZAR), assess_fit and add_vars.
	...
	\begin{todolist}
		...
		\item In construct_panel include sdprm and spcyc in variables to pull.
		...
		\item Re-estimate flexible models (mnsf, mssf): HUF, IDR, ILS, MYR, THB, TRY, ZAR.
		\item Re-estimate  flexible models (mnsf, mssf): PHP.
	\end{todolist}
