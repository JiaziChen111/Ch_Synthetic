...
\begin{todolist}
	...
	\begin{todolist}
		...
		\item Compare results against previous ones. IDR : fit is bad, yP is far from scbp, TP seems too high. TRY: TP seems to high. ILS: TP seems to high.
		\item[\done] Solution for ILS: inflation highly correlated w/ IDR, KRW, PHP, THB. How good SCPI vs INF.
		\item HP for the inflation of ILS and ZAR as SCPI.
	\end{todolist}
