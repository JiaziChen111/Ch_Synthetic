...
\gototoc
	...
	\begin{todolist}
		...
		\item Repeat exercise but using fminsearch instead of fminunc.
	\end{todolist}
	\item Update LP figures in Stata: 30 and 60 days. May need to re-run them since estimates from fminseach might still be valid.
	\item Call to splityldssvys in atsm_estimation, se_state.
