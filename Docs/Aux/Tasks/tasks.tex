...
\gototoc
\begin{todolist}
	\item Update loadings4ylds: help, round maturities so that input as [0.25 1:5:10]
	\item Update Kfs: remove nargin for mu_x and mu_y
...
\gototoc
\begin{todolist}
	\item Explicit that longer series for AEs and surveys for EMs. Also, no surveys for AEs for comparison w/ other studies. % :)
	...
	\item Structure for the US YC. In daily2monthly for US extract LCNOM, OIS, FF.
	\item Decompose US YC.
	\item Use surveys to decompose US YC and compare to Guimaraes.
