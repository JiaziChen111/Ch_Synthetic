...
\begin{todolist}
	\item Tables
	\begin{todolist}
		\item TP synt EMs and TPnom AEs. Average. Compare w/ average YC slope. Compare TPs w/ empirical measures as in Curcuru et al. 2018. Compare against survey-based TP.
		...
		\item Fit. RMSE. Averages per country. Nominal and synthetic.
		...
		\item Average real interest rate to see if on average is the same across EMs.
