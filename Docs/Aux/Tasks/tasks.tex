...
\begin{todolist}
	\item Tables.
	\begin{todolist}
		\item Descriptive table of YCs (nominal and synthetic) as in Guimaraes. Highlight the higher std of the short end of their curves! Are yields and components more volatile in EM than in AEs? Are the two types of YCs upward sloping?
