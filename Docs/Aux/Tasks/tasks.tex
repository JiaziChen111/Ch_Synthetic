...
\begin{todolist}
	...
	\item Tables.
	\begin{todolist}
		\item Add user-written commands in macros.tex.
		\item Personalize wrapper for tablenotes.
		\item Define a new environment for template to create standalone table wrappers. Two versions: w/ notes and w/o notes.
		\item Create version for paper starting w/ n and version for slides starting w/ u.
		\item Add notes to tables.
		\item Descriptive table of YCs as in Guimaraes. Highlight the higher std of the short end of their curves! Are yields and components more volatile in EM than in AEs?
