...
\begin{todolist}
	...
	\begin{todolist}
		...
		\item Update LPs for AE/EM for all subsamples after DK and compare vs pre-DK.
		\item LPs for regions of EM and blocks of AE. Create blocks for AEs as EM regions.
	\end{todolist}
	\item TP regressions. 
	\begin{todolist}
