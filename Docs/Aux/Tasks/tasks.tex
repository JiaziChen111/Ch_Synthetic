...
\begin{todolist}
	...
	\begin{todolist}
		...
		\item LPs. Update equation and figures (including path pre/post).
	...
	\item Wording.
	\begin{todolist}
		\item Remove that only FOMC meetings but leave that no minutes nor speeches.
		\item Footnote for differences in SPF-SPD-SMP.
		\item Reason to use CRSP: GSW doesn't target ST, follow Golinski \& Spencer.
