...
\begin{todolist}
	...
	\begin{todolist}
		\item Recalculate implied forecasts of EM short rates considering currency risk premia.
		...
		\item Risks of global investors when investing in LC bonds: risk of a LC depreciation, risk of default.
...
\begin{todolist}
	\item Slides.
	\begin{todolist}
		\item Figures. Labels, titles, notes. Clearly state maturity of the yield reported.
		\item Tables and figures. Add circles/rectangles or highlight numbers w/ color.
		\item Explanation of bias in VAR is b/c state variable is very persistent.
		\item Reason to use CRSP: GSW doesn't target ST.
	\end{todolist}
	\item Fisher equation rather than approximation for US real rate and EM nominal rate. Start sample for Russia 1 or 2 months after the current initial date.
	\item Compare scbp obtained w/ SPF data vs survey data from other AEs.
	\item Compare my TPMX against Blake et al. Both TP nom and TPsynt.
	\item Are big changes in TP related to local events?
	\item Make reference to Chernov, Schmidt, Song about credit risk in US YC.
